...
def login_screen():
    ...
    col2.title("Mekgoro Secure Access")
    pwd = col2.text_input("Enter Master Password", type="password")
    user = col2.selectbox("Select Your Name", ["Ndule", "Tshepo (Driver)", "Biino", "Anthony", "Mike"])
...
with tab2:
    ...
    if vendor:
        # Predictive Item List for this supplier
        ...
        with st.form("in_form", clear_on_submit=True):
            ...
            manual = st.text_input("OR Type New Item Name")
...
with tab3:
    ...
    if stock.empty:
        ...
        with st.form("out_form"):
            choice = st.selectbox("Item", stock['item_name'].tolist())
